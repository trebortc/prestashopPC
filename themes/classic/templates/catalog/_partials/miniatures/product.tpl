      ...
      <div class="product-description" style="height: 170px;">
        {block name='product_name'}
          {if $page.page_name == 'index'}
            <h3 class="h3 product-title" itemprop="name"><a href="{$product.url}"><i class="material-icons local_offer"></i>{$product.name|truncate:30:'...'}</a></h3>
          {else}
            <h2 class="h3 product-title" itemprop="name"><a href="{$product.url}"><i class="material-icons local_offer"></i>{$product.name|truncate:30:'...'}</a></h2>
          {/if}
        {/block}
            ...
            <div class="product-price-and-shipping">
              ...
              <div class="clearfix atc_div">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <button class="add_to_cart btn btn-secondary btn-sm" onclick="mypresta_productListCart.add({literal}$(this){/literal});">
