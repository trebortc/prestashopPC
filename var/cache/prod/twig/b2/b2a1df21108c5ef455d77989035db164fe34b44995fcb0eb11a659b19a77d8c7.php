...
class __TwigTemplate_e03a8594935700d8b8a004d99894c9c6260f0b4a7c4a5fe0aa4482680abf4735 extends Twig_Template
{
...
($context["module"] ?? null), "attributes", array()), "url_active", array()) != "buy")) {
      ...
      <div class=\"module-badges-action\">
        ...
        <div class=\"float-right module-action\">
          ";
        // line 202
        $this->loadTemplate("PrestaShopBundle:Admin/Module/Includes:action_menu.html.twig", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", 202)->display(array_merge($context, array("module" => ($context["module"] ?? null), "level" => ($context["level"] ?? null))));
        // line 203
        echo "        </div>
      </div>
    </div>
...
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", "C:\\xampp\\htdocs\\prestashopcompu\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\modal_read_more_content.html.twig");
    }
}
